...
if (!function_exists('sleeky_styles')){
	function sleeky_styles() {
    	...
    	wp_enqueue_style( 'sleeky_lato', '//fonts.googleapis.com/css?family=Lato:100,300,400,700,900', array(), '1.2', 'all' );
		...
		wp_enqueue_style( 'sleeky_main_child', get_stylesheet_directory_uri().'/css/sleeky.css' );
