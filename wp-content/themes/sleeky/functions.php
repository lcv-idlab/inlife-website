...
require get_template_directory(). '/sleeky-upsells/sleeky-pro-btn/class-customize.php';
...
function sleeky_post_meta() {
    ...
    $out .= sprintf( __( '%1$s', 'sleeky' ), $date );
 ...
 */
function sleeky_theme_customize_css()
{
    get_template_part('inc/sleeky_customizer_css');
}

add_action( 'wp_head', 'sleeky_theme_customize_css');
...
function sleeky_move_to_top_fnc() {
...
add_action('sleeky_lr_move_to_top', 'sleeky_move_to_top_fnc');

if ( ! function_exists( 'sleeky_the_custom_logo' ) ) :
...
function sleeky_the_custom_logo() {
